                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Delivery Zone Summary Edit </h4><br><br>

                            <form method="GET" action="{{ route('deliveryzone.invoice.summary.edit') }}">
                                <div class="row">
                                                        ...
                                                        <table class="table table-striped table-bordered report-table">
                                                            <thead>
                                                                <tr class="table-primary">
                                                                    ...
                                                                    <td class="text-center"><strong>Sell Quantity</strong></td>
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    @foreach ($Data->invoice_details as $key => $item)
                                                                        @php
                                                                            ...
                                                                            if(isset($products[$item->product_id])){
                                                                                ...
                                                                                // $products[$item->product_id]['selling_price'] += ($products[$item->product_id]['selling_qty'] * $products[$item->product_id]['unit_price']) - $products[$item->product_id]['total_sell_commission'];
                                                                            }else{
                                                                ...
                                                                @endphp
                                                                    <tr>
                                                                        <input type="hidden" class="form-control" name="unit_price[]" oninput="priceUpdate()" value="{{$product["unit_price"]??''}}" style="width:100px;"/>
                                                                        <input type="hidden" class="form-control" name="total_sell_commission[]" oninput="priceUpdate()" value="{{$product["total_sell_commission"]??''}}" style="width:100px;"/>
                                                                        <td>{{ ++$Sl }} </td>
                                                                        <td>{{ $product["name"]??'' }}</td>
                                                                        <td>{{ $product["selling_qty"]??'' }}</td>
                                                                        <td><input class="form-control" name="selling_qty[]" oninput="priceUpdate()" value="{{$product["selling_qty"]??''}}" style="width:100px;"/></td>
                                                            ...
                                                            <tfoot>
                                                                <tr class="tfoot-row">
                                                                    ...
                                                                    <td class="no-line text-Center">
                                                                        <h4 class="m-0 total-selling-qty">{{ $_total_qty }}</h4>
                                                                    </td>
                                                                    <td class="no-line text-Center">
