                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><strong>SB Com</strong></td>
                                                                    <td class="text-center"><strong>MC Com</strong></td>
                                                                    <td class="text-center"><strong>SP Com</strong></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">{{ $item->total_db_com }}</td>
                                                                    <td class="text-center">{{ $item->total_mc_com }}</td>
                                                                    <td class="text-center">{{ $item->total_sp_com }}</td>
