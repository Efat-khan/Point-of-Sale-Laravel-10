...
<div class="page-content">
                            ...
                            <table class="table-sm table-bordered" width="100%" style="border-color: #ddd;">
                                ...
                                <tbody id="addRow" class="addRow">
                                    ...
                                    <tr class="delete_add_more_item" id="delete_add_more_item">
                                        ...
                                        <input type="hidden" name="product_id[]" value="{{$purchase_details->product_id ?? ''}}">
                                        <td>{{ $purchase_details['product']->name ?? '' }}-{{$purchase_details['product']['brand']->name ?? ''}}({{$purchase_details['product']->tax_type}})</td>
                                        <td>
    ...
    <script id="document-template" type="text/x-handlebars-template">
        <tr class="delete_add_more_item" id="delete_add_more_item">
            ...
            <td>
                <input type="number"  min="1" max="@{{quantity}}" class="form-control buying_qty text-right" name="buying_qty[]" id="buying_qty" value="0"> 
