...
<body class="d-flex flex-column min-vh-100" style="margin-left: 42px;">
    ...
    <table class="invoice-table" style="width: 100%; border-collapse: collapse; margin-top: 0px; font-size: 1rem;">
      ...
      <tbody>
        ...
        <tr style="border-bottom: 1px solid #000;">
          ...
          <td style="padding: 8px 12px; text-align: left;">{{ $details->product_name }}</td>
        ...
        @if (!empty($purchase_additional_charge_ids))
        @php
        ...
        $purchase_additional_charge_ids = json_decode($data['total_additional_fees_type'], true);
  ...
  <footer class="text-center mt-1 text-muted d-flex justify-content-center px-3"
    ...
    <small>ECS Engineering | Purchase No: {{ $data['purchase_no']}} | Generated By: {{ Auth::user()->name }} | At: {{ now()->format('d-m-Y  h:i A') }}</small>
  </footer>
</body>
